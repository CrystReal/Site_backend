...
class StaticPages extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('parent, feedback, candelete, sort, type, menu_show, iscat, isInContent', 'numerical', 'integerOnly' => true),
    ...
    public function afterDelete()
    {
        ...
        $this->updateAll(array("parent=" . $this->id), array("parent=" . $this->id));
        parent::afterDelete();
    }
