...
class TbInputHorizontal extends TbInput
{
	...
	protected function dropDownList()
	{
        ...
        if(isset($this->htmlOptions['class']))
            $this->htmlOptions['class'] = $this->htmlOptions . " form-control";
        else
	...
	{
		echo $this->getLabel();
		echo '<div class="col-md-9"><span id="' . $this->getAttributeId($this->attribute) . '">';
	...
	protected function textField()
	{
		...
		echo $this->getPrepend();
        if(isset($this->htmlOptions['class']))
            $this->htmlOptions['class'] = $this->htmlOptions['class'] . " form-control";
        else
            $this->htmlOptions['class'] = "form-control";
