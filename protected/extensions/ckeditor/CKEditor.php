...
//advanced - пользователь сам определяет тулбар
    private $allowedEditorTemplates = array('full', 'basic', 'advanced', 'my');
    ...
    private $toolbar_my = array(
        array('Source', '-', 'Save', 'DocProps', 'Preview', 'Print' /* ,'-','Templates' */),
    ...
    protected function makeOptions()
    {
        ...
        switch ($this->editorTemplate) {
            ...
            case 'basic':
                ...
                break;
            case 'my':
                $options['toolbar'] = $this->toolbar_my;
                break;
            default:
