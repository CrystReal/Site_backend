...
(function ($) {
    ...
    $.fn.extend({
        inputlengthalert: function (options, callback) {
            ...
            var documentBody = $('body'),
                defaults = {
                    ...
                    preText: '',
                    postText: '',
                    reachedText: 'You reach recomended limit',
                    showMaxLength: true,
                    placement: 'bottom',
            ...
            function updateMaxLengthHTML(maxLengthThisInput, typedChars) {
                ...
                if (options.message) {
                    ...
                    if (maxLengthThisInput - typedChars <= 0) {
                        output = options.reachedText;
                    } else {
                        if (options.preText) {
